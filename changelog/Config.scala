...
object Config:
  def loadFromEnv: Config =
    ...
    val releaseVersion = Version.parse(Properties.envOrElse("TOOLKIT_VERSION_RELEASE", "0.8.1"))
    val developmentVersion = Version.parse(Properties.envOrElse("TOOLKIT_VERSION_DEVELOPMENT", "0.9.0"))
